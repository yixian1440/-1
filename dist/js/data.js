        ...
        $.ajax({
            ...
            <div class = "home-brick-box home-brick-row-2-box xm-plain-box">
                ...
                for (var i = 0; i < firstData.childs.length; i++) {
                    var nodechild = $(` <li class = 'brick-item brick-item-m brick-item-m-2'>
                   <a href="# ">
                    ...
                    nodechild.appendTo(node.find(".hox-bd .span16 ul"));
                }
                ...
                <div class = 'home-brick-box home-brick-row-2-box xm-plain-box'>
                   ...
                   </div>`).appendTo(node1.find(".span16 .brick-list").eq(0));
                   ...
                   </div>`).appendTo(node1.find(".span16 .brick-list").eq(1));
                    }
                    $(` <li class='brick-item brick-item-s'>
                             <a href="#">
                       <div class='figure figure-more'>
